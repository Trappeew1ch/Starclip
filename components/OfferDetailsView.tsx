    ...
    <div className="w-full flex flex-col pt-4 pb-24 animate-in slide-in-from-right duration-300 relative min-h-screen bg-[#09090b] overflow-hidden">
        ...
        <div className="px-4 mt-6 relative z-10">
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
                ...
                {/* Platforms */}
                <div className="bg-[#18181b]/60 border border-white/5 rounded-2xl p-4 flex flex-col justify-between h-24 relative overflow-hidden group hover:border-white/10 transition-colors">
                    <div className="absolute -right-4 -top-4 w-16 h-16 bg-pink-500/10 rounded-full blur-xl group-hover:bg-pink-500/20 transition-colors"></div>
                    <div className="flex items-center gap-2 z-10">
                ...
                {/* Payment */}
                <div className="bg-[#18181b]/60 border border-white/5 rounded-2xl p-4 flex flex-col justify-between h-24 relative overflow-hidden group hover:border-white/10 transition-colors">
                     <div className="absolute -right-4 -top-4 w-16 h-16 bg-green-500/10 rounded-full blur-xl group-hover:bg-green-500/20 transition-colors"></div>
                     <div className="flex items-center gap-2 z-10">
                ...
                {/* Rate */}
                <div className="bg-[#18181b]/60 border border-white/5 rounded-2xl p-4 flex flex-col justify-between h-24 relative overflow-hidden group hover:border-white/10 transition-colors">
                    <div className="absolute -right-4 -top-4 w-16 h-16 bg-yellow-500/10 rounded-full blur-xl group-hover:bg-yellow-500/20 transition-colors"></div>
                    <div className="flex items-center gap-2 z-10">
