...
async function parseYouTubeStats(videoUrl) {
    let browser;
    try {
...
async function parseTikTokStats(videoUrl) {
    let browser;
    try {
        browser = await puppeteer.launch({
            headless: true,
...
async function parseInstagramStats(videoUrl) {
    let browser;
    try {
        browser = await puppeteer.launch({
            headless: true,
...
export async function getVideoStats(videoUrl, platform) {
    switch (platform) {
        case 'youtube':
